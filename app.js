...
const pitanja = [
    ...
    },
    {
     ...
     {
      pitanje: "Kako se naziva globalna svjetska mreza namijenjena slobodnom pristupu svim korisnicima?",
      odgovori: {
        a: "Internet",
        b: "Intranet",
        c: "Iskon"
    ...
    {
      pitanje: "Kako se zove skup pravila koji opisuje nacin prenosenja podataka mrezom?",
      odgovori: {
        a: "Protokol",
        b: "Hiperlink",
        c: "E-mail"
    ...
    {
      pitanje: "Kako nazivamo uredjaj koji omogucava komunikaciju medju racunarima putem telefonske linije?",
      odgovori: {
        a: "Modem",
        b: "Mrezna kartica",
        c: "Ruter"
